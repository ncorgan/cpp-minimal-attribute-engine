...
MSVC_VERSIONS = [
    {"num": 12, "year": 2013, "stds": [], "boost": "1_58_0"},
    {"num": 14, "year": 2015, "stds": ["c++14"], "boost": "1_63_0"},
    {"num": 15, "year": 2017, "stds": ["c++14","c++17","c++latest"], "boost": "1_69_0"},
]
...
if __name__ == "__main__":
    ...
    yml = {
        ...
        "build_script": [
            "mkdir build",
            "cd build",
            "cmake -G \"%GENERATOR_NAME%\" -DCMAKE_BUILD_TYPE=Release -DCMAKE_CXX_FLAGS=/D_SILENCE_TR1_NAMESPACE_DEPRECATION_WARNING -DBOOST_ROOT=C:/Libraries/boost_%BOOST_VERSION% ..",
